...
const platformStats = computed(() => {
    const stats = {};
    posts.today.posts.forEach((post) => {
...
<template>
    <div class="space-y-6">
        ...
        <div v-if="!posts.loading && platformStats.length > 0" class="grid grid-cols-2 gap-4 sm:grid-cols-4 lg:grid-cols-5">
            <div v-for="stat in platformStats" :key="stat.name" class="rounded-2xl bg-white px-4 py-3 shadow-sm ring-1 ring-slate-200">
                ...
                <ul class="divide-y divide-slate-100">
                    ...
                    >
                        ...
                        <div class="flex shrink-0 flex-wrap items-center gap-2">
                            <template v-if="post.status !== 'posted' && post.status !== 'skipped'">
                                <button
                                    type="button"
